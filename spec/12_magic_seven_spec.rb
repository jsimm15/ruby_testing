...
describe MagicSeven do
  ...
  describe '#subtract_random_number' do
    context 'when random number is 15 and previous step is 20' do
      it 'returns 5' do
        previous_step = 20
  ...
  describe '#play' do
    ...
    context 'when the random number is 66' do
    ...
    context 'when the random number is 75' do
      subject(:game) {described_class.new(75)}
      # remove the 'x' before running this test
      it 'will return 7' do
        expect(game.play).to eq(7)
      end
